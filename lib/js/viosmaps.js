...
var viosFunctions = require('vios-functions');

console.log("viosFunctions:", viosFunctions);

// function openURLwithTarget( url, target ) {
...
window.onload = function () {
    ...
    Snap.load("assets/argentina_map.svg", function (f) {
        ...
        function clickRegion(event) {
            ...
            openURLwithTarget( regionURL, target );
        }
