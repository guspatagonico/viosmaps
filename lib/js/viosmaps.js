...
var $ 			= require('jQuery'),
	jqBrowser  	= require('jquery.browser'),
	Snap 		= require('snapsvg'),
	vios		= require('./vios-functions.js');
	
// console.log("vios:", vios);
// console.log("vios.openURLwithTarget:", vios.openURLwithTarget);
...
window.onload = function () {
	...
	Snap.load("assets/argentina_map.svg", function (f) {
		...
		function clickRegion(event) {
			...
			vios.openURLwithTarget( regionURL, target );
		}
